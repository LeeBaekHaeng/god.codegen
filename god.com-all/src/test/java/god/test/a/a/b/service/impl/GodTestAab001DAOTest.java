 ...
 *
 */
@ContextConfiguration(classes = { GodTestAab001DAOTest.class, EgovTestAbstractDAO.class, })
...
@NoArgsConstructor
@Slf4j
public class GodTestAab001DAOTest extends EgovTestAbstractDAO {

    /**
     * 
     */
    @Autowired
    private GodTestAab001DAO godTestAab001DAO;
...
//    }
     ...
     * @param testData
     */
    private void testData(final GodTestAab001VO testData) {
        // given
    ...
    public void select() {
        ...
        // when
        final GodTestAab001VO result = godTestAab001DAO.select(vo);
        final GodTestAab001VO result2 = godTestAab001DAO.select(vo);
    ...
    private void assertSelect(final GodTestAab001VO testData, final GodTestAab001VO result) {
        if (log.isDebugEnabled()) {
...
//        vo.setSearchCondition("0");
        ...
        // when
        final List<GodTestAab001VO> resultList = godTestAab001DAO.selectList(vo);
    ...
    private void assertSelectList(final GodTestAab001VO testData, final List<GodTestAab001VO> resultList) {
//        assertFalse(egovMessageSource.getMessage("fail.common.select"), resultList.isEmpty());
        ...
        for (final GodTestAab001VO result : resultList) {
            if (log.isDebugEnabled()) {
                log.debug("i={}", i);
