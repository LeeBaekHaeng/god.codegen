package god.admin2.cmm.service;
 ...
 *
 * 수정일 수정자 수정내용 ---------- -------- --------------------------- 2009.01.19 박지욱
 * 최초 생성 2011.07.20 서준식 Globals파일의 상대경로를 읽은 메서드 추가 2014.10.13 이기하
 * Globals.properties 값이 null일 경우 오류처리 2019.04.26 신용호 RELATIVE_PATH_PREFIX Path
 * 적용 방식 개선 2022.01.21 윤주호 Try-catch-resource 조치 및 Method Refactoring
 *
...
public class Admin2Properties {

	private static final Logger LOGGER = LoggerFactory.getLogger(Admin2Properties.class);
	...
	public static final String RELATIVE_PATH_PREFIX = Admin2Properties.class.getResource("") == null ? ""
			: Admin2Properties.class.getResource("").getPath().substring(1,
					Admin2Properties.class.getResource("").getPath().lastIndexOf("admin2"));
	...
	public static String getProperty(String keyName) {
		...
		LOGGER.debug("===>>> getProperty" + EgovStringUtil
				.isNullToString(Admin2Properties.class.getProtectionDomain().getCodeSource().getLocation().getPath()));
