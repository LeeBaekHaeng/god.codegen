 ...
 * @ @ 수정일 수정자 수정내용 @ ---------- -------- --------------------------- 2009.03.02
 *   조재영 최초 생성 2011.10.07 이기하 .action -> .do로 변경하면서 동일 매핑이 되어 삭제처리 2015.11.12
 *   김연호 한국인터넷진흥원 웹 취약점 개선 2019.04.25 신용호 moveToPage() 화이트리스트 처리 2022.11.11 김혜준
 *   시큐어코딩 처리 2023.05.23 신용호 moveToPage() 추가 보완 조치
 *
