...
@NoArgsConstructor
@Slf4j
class c02_상세화면_삭제버튼 extends 셀레늄_테스트 {
	...
	private void 삭제버튼을_클릭한다() {
		final WebElement element = driver.findElement(By.cssSelector("[name=formDelete] .s_submit"));
		element.click();
		정지();
