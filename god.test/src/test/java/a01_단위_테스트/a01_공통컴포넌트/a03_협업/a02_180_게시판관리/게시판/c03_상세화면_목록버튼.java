...
@NoArgsConstructor
@Slf4j
class c03_상세화면_목록버튼 extends 셀레늄_테스트 {
	...
	private void 목록버튼을_클릭한다() {
		final WebElement element = driver.findElement(By.cssSelector("[name=formList] .s_submit"));
		element.click();
		정지();
	}
