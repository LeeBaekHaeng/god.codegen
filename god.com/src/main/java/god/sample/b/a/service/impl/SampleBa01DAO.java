 ...
 */
@Repository
public class SampleBa01DAO extends GodCoreCmmV1AbstractDAO<SampleBa01VO, SampleBa01VO> {

	/**
	 * 네임스페이스 값설정
	 */
	public SampleBa01DAO() {
		super();
	 ...
	 * @return
	 */
	public int insert3(final SampleBa01VO vo) {
	 ...
	 * @return
	 */
	public SampleBa01VO select3(final SampleBa01VO vo) {
	 ...
	 * @return
	 */
	public List<SampleBa01VO> select3List(final SampleBa01VO vo) {
	 ...
	 * @return
	 */
	public int select3ListTotCnt(final SampleBa01VO vo) {
	 ...
	 * @return
	 */
	public int update3(final SampleBa01VO vo) {
	 ...
	 * @return
	 */
	public int delete3(final SampleBa01VO vo) {
	 ...
	 * @return
	 */
	public int merge3(final SampleBa01VO vo) {
	 ...
	 * @return
	 */
	public int multi3(final SampleBa01VO vo) {
