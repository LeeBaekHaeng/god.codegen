...
public abstract class EgovAbstractServiceImpl {
	 ...
	 * @return Exception EgovBizException 객체
	 */
	protected EgovBizException processException(final String msgKey, EgovBizException exception) {
	 ...
	 * @return Exception EgovBizException 객체
	 */
	protected EgovBizException processException(final String msgKey, final String[] msgArgs, final EgovBizException exception) {
	 ...
	 * @return Exception EgovBizException 객체
	 */
	protected EgovBizException processException(final String msgKey, final String[] msgArgs, final EgovBizException exception, Locale locale) {
	 ...
	 * @return Exception EgovBizException 객체
	 */
	protected EgovBizException processException(final String msgKey, final String[] msgArgs, final EgovBizException exception, final Locale locale, ExceptionCreator exceptionCreator) {
