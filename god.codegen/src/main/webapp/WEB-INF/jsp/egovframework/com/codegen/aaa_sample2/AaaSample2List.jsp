...
<%
 /**
  * @Class Name : AaaSample2List.jsp
  * @Description : AaaSample2 List 화면
...
function fn_egov_update(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/aaaSample2/updateAaaSample2.do'/>";
   	document.getElementById("listForm").submit();
}

function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/aaaSample2/selectAaaSample2.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/aaaSample2/insertAaaSample2.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/aaaSample2/selectAaaSample2List.do'/>";
   	document.getElementById("listForm").submit();
}
...
<body>
<form:form modelAttribute="aaaSample2VO" name="listForm" id="listForm" method="get">
