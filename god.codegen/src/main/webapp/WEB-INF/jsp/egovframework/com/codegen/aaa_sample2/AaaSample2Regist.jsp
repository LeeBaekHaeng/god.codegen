...
<c:set var="registerFlag" value="${empty aaaSample2VO.id ? '등록' : '수정'}"/>
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/aaaSample2/insertAaaSample2.do' : '/aaaSample2/updateAaaSample2.do'}"/>";
    frm.submit();
