...
public class A1_postgres_INFORMATION_SCHEMA_TABLES_batchmenubind_메뉴샘플 {
...
//			egovLogger.debug("con={}", con);
			...
			try (
					...
					ResultSet tables = stmt.executeQuery(
							"SELECT a.*, obj_description(format('%s.%s', a.table_schema, a.table_name)::regclass::oid, 'pg_class') as table_comment FROM INFORMATION_SCHEMA.TABLES a WHERE table_catalog = 'com' and TABLE_SCHEMA = 'public' order by table_catalog, table_schema, table_name");
