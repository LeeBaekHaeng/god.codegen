...
public class B1_postgres_INFORMATION_SCHEMA_COLUMNS {
...
//			egovLogger.debug("con={}", con);
			...
			try (
					...
					ResultSet columns = stmt.executeQuery(
							"SELECT a.*, col_description(format('%s.%s', a.table_schema, a.table_name)::regclass::oid, a.ordinal_position) as column_comment FROM INFORMATION_SCHEMA.COLUMNS a WHERE table_catalog = 'com' and TABLE_SCHEMA = 'public' order by table_catalog, table_schema, table_name, ordinal_position");
